...
القواعد:
1. قسّم النص إلى فقرات منطقية مترابطة (من 3 إلى ${MAX_PARAGRAPHS} فقرة قدر الإمكان، وكلما كان النص أطول زاد عدد الفقرات). إذا كان النص كتلة واحدة متصلة، قسّمه حسب المواضيع أو مجموعات الجمل المتقاربة، احرص على أن تكون كل فقرة ناتجة تشتمل على معاني مفهومة غير غامضة.
